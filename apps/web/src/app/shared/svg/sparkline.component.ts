...
@Component({
  ...
  template: `
    <svg:svg [attr.width]="width" [attr.height]="height" [attr.viewBox]="'0 0 ' + width + ' ' + height" class="sparkline">
      <svg:path [attr.d]="path" [attr.stroke]="color" [attr.stroke-width]="strokeWidth" fill="none" />
    </svg:svg>
  `,
  styles: [`
    .sparkline {
...
export class SparklineComponent {
  ...
  private generatePath(normalized: number[], width: number, height: number, padding: number): string {
