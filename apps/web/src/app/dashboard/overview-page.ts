...
import {
  ...
  PresalesRatePipe,
  AvgVelocityPipe,
  AttentionRequiredCountPipe,
  AttentionRequiredPipe,
  TopByMarginPipe,
  PromotionsCountPipe,
} from './pipes/dashboard-pipes';
  ...
  template: `
    <div class="overview-page">
      ...
      <p class="page-description">
        Estado agregado de la cartera ·
        {{ promotions$ | async | promotionsCount: 'total' }} promociones activas ·
        {{ promotions$ | async | attentionRequiredCount }} requieren atención
      </p>
      ...
      <div *ngIf="(promotions$ | async) !== null" class="overview-content">
        ...
        <div class="kpi-grid">
          ...
          <div class="card kpi-card">
            ...
            <div class="kpi-value">
              {{ promotions$ | async | avgVelocity | number: '1.0-1' }} uds/mes
            </div>
            <div class="kpi-foot">
        ...
        <div class="section">
          <div class="section-head">
            ...
            <span class="meta"
              >{{ promotions$ | async | attentionRequiredCount }} promociones en zona de
              alerta</span
            >
          </div>
          <div class="attention-grid">
            <ng-container *ngIf="promotions$ | async as promotions">
              <ng-container *ngIf="promotions.length > 0; else noAttention">
                <div
                  *ngFor="let promo of promotions | attentionRequired: 3"
                ...
                >
                  ...
                  <div class="reason">
                    ...
                    {{
                      getPromotionStatus(promo) === 'red'
                        ? 'fuera de objetivo, revisar costes de construcción y alcance'
                        : 'en zona de vigilancia, monitoring semanal recomendado'
                    }}
                  </div>
                </div>
              </ng-container>
        ...
        <div class="section">
          <div class="card">
            ...
            <div class="top-list">
              <ng-container *ngIf="promotions$ | async as promotions">
                <div
                  *ngFor="let promo of promotions | topByMargin: 5; let i = index"
                  class="top-item"
                >
                  ...
                  <span class="value"
                    >{{ promo.financials?.projected_margin_pct ?? 0 | number: '1.0-1' }}%</span
                  >
                </div>
              </ng-container>
            </div>
          ...
          <div class="card">
            ...
            <div class="timeline">
              <div class="timeline-item">
                ...
                <div class="body">
                  <span class="who">La Marina - Fase 2</span> · Reunión de seguimiento con jefe de
                  proyecto. Avance estructural según plan.
                </div>
              </div>
              <div class="timeline-item">
                ...
                <div class="body">
                  <span class="who">Mirador del Mar</span> · Aprobación de modificaciones de
                  acabados por parte de comprador clave.
                </div>
              </div>
              <div class="timeline-item">
                ...
                <div class="dot amber"></div>
                <div class="body">
                  <span class="who">Los Naranjos</span> · Entregada documentación para solicitud de
                  licencia de obra.
                </div>
              </div>
              <div class="timeline-item">
                ...
                <div class="dot green"></div>
                <div class="body">
                  <span class="who">Cala Serena</span> · Avance del 60% en due diligence ambiental
                  del suelo.
                </div>
              </div>
            </div>
